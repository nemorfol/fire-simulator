export function popolaDatiIniziali(
  ...
  datiEsempio.usciteRicorrenti.forEach((d) => formInputs.usciteRicorrenti.push(d));
  ...
  // Imposta i valori singoli, inclusa la nuova età massima
  formInputs.etaMassimaSimulazione = datiEsempio.etaMassimaSimulazione || 95;
